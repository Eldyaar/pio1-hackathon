          ...
          <List.Item.Meta
            ...
            description={
              <div style={{display: 'flex', justifyContent: 'space-between'}}>
                <Typography.Paragraph style={{fontWeight: 400, width: '90%'}} >
                  {item.message}
                </Typography.Paragraph> 
                <Typography.Paragraph style={{fontWeight: 300, width: '5%'}} >
                  {Intl.DateTimeFormat('ru-RU', {hour: 'numeric', minute: '2-digit', 'hour12': true}).format(item.date)}
                </Typography.Paragraph>
              </div>
            }
          />
